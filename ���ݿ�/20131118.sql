...
INSERT INTO `lfy_config` VALUES ('mobile_bind_secret', '手机微信绑定密钥', '手机微信管理绑定的安全密钥', '1234', '1', '2', '0', '', '2');
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='手机微信管理绑定名单';
...
-- Records of lfy_user
-- ----------------------------
INSERT INTO `lfy_user` VALUES ('1', 'admin', '管理员', 'db69fc039dcbd2962cb4d28f5891aae1', '0', '127.0.0.1', '1384743358', '1', '1', '管理员');

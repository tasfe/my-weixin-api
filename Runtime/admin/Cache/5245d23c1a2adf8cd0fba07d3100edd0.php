...
<div class="container">
    ...
    <div class="row">
        <div class="span12">
            <div class="pull-left">
                <a href="<?php echo U('/'.$module_name);?>" class="btn btn-primary">微信菜单管理</a>&nbsp;&nbsp;
                <a href="<?php echo U($module_name.'/add_submenu?id='.$main_id);?>" class="btn btn-primary">新增子菜单</a>
            </div>
        </div>
        <div class="span12" style="margin-top:10px;">
            ...
            <table class="table table-hover">
                ...
                <tfoot>
                    <tr>
                        <td colspan="6"><div class="row pagination page"><div class="span12"><?php echo ($page); ?></div></div></td>
                    </tr>
                </tfoot>
                <tbody>

...
<div class="container">
    ...
    <div class="page-header"><h4>文本指令管理</h4></div>
    ...
    <div class="row">
        <div class="span12">
            ...
            <ul class="nav pull-right">
                <form action="" method="get">
                    <li class="pull-left">
                        <input type="text" placeholder="指令模糊查找" name='code' value="<?php echo ($code); ?>" class="input-medium search-query">
                    </li>
                    <li class="pull-left">
        ...
        <div class="span12" style="margin-top:10px;">
            ...
            <table class="table table-hover">
                ...
                <tfoot>
                    <tr>
                        <td colspan="12"><div class="row pagination page"><div class="span12"><?php echo ($page); ?></div></div></td>
                    </tr>
                </tfoot>
                <tbody>
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr id='tr_<?php echo ($vo["id"]); ?>'>
                        ...
                        <td><?php echo get_main_str($vo['main']);?></td>

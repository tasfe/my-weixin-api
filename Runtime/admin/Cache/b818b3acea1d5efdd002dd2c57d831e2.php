...
<div class="container">
    <div class="page-header"><h4>微信兑换记录</h4></div>
    <div class="row">
        <div class="span12">
            <div class="pull-left">
        ...
        <div class="span12" style="margin-top:10px;">
            ...
            <table class="table table-hover">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr id='tr_<?php echo ($vo["id"]); ?>'>
                        ...
                        <td><?php echo ($vo["user_telephone"]); ?></td>
                        <td><?php echo ($vo["goods_name"]); ?></td>
                        <td><?php echo get_date_full($vo['record_time']);?></td>
                        <td><?php echo get_date_full($vo['duihuan_time']);?></td>

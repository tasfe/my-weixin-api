...
<div class="container">
    ...
    <div class="page-header"><h4>奖品兑换</h4></div>
    <div class="row">
        <div class="span12">
            <div class="pull-left">
                <a href="<?php echo U('/'.$module_name);?>" class="btn btn-primary">刷新</a>&nbsp;&nbsp;
            </div>
        </div>
    </div>
    <div class="row">
        <div class="span12" style="margin-top:10px;">
            <form class="form-horizontal" method="post" action="<?php echo U('duijiang/get_code');?>">
                <fieldset>
                    <div id="legend" class="">
                        <legend class=""></legend>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="input01">兑奖码</label>
                        <div class="controls">
                            <input type="text" name="code" placeholder="请输入兑奖码" value="" class="input-xlarge">
                        </div>
                    </div>
                        <div id='pop'></div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary">验证信息</button>
                        </div>
                </fieldset>
            </form>
        </div>

...
<div class="container">
    ...
    <div class="row">
        <div class="span12">
            <div class="pull-left">
                <a href="<?php echo U($module_name.'/duihuan');?>" class="btn btn-primary">刷新</a>&nbsp;&nbsp;
            </div>
        </div>
    </div>
    <div class="row">
        <div class="span12" style="margin-top:10px;">
            <form class="form-horizontal" method="post" action="<?php echo U($module_name.'/get_code');?>">
                <fieldset>
                    <div id="legend" class="">
                        <legend class=""></legend>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="input01">秒杀兑换码</label>
                        <div class="controls">
                            <input type="text" name="code" placeholder="请输入秒杀兑换码" value="" class="input-xlarge">
                        </div>
                    </div>
                        <div id='pop'></div>

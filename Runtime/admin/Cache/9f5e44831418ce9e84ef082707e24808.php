...
<div class="container">
    <div class="page-header"><h4>[<?php echo get_menu_name($menu_id);?>]子菜单添加</h4></div>
    <div class="row">
        <div class="span12">
            <div class="pull-left">
                <a href="<?php echo U('/'.$module_name.'/index_submenu?menu_id='.$menu_id);?>" class="btn btn-primary">列 表</a>&nbsp;&nbsp;
                <!--<a href="<?php echo U($module_name.'/add_submenu?id='.$menu_id);?>" class="btn btn-primary">新 增</a>&nbsp;&nbsp;-->
            ...
            <form class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-actions">
                        <input type="hidden" name="main" value="<?php echo ($menu_id); ?>" />

...
<div class="container">
    <div class="page-header"><h4>活动管理</h4></div>
    <div class="row">
        <div class="span12">
            <div class="pull-left">
        ...
        <div class="span12" style="margin-top:10px;">
            ...
            <table class="table table-hover">
                ...
                <tfoot>
                    <tr>
                        <td colspan="9"><div class="row pagination page"><div class="span12"><?php echo ($page); ?></div></div></td>
                    </tr>
                </tfoot>
                <tbody>
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr id='tr_<?php echo ($vo["id"]); ?>'>
                        ...
                        <td><?php echo get_choujiang_type_name($vo['type']);?></td>
                    ...
                    <td><?php echo ($vo["user_sum_num"]); ?></td>
                    <td><?php echo get_choujiang_user_num($vo['id']);?></td>
                    <td>
                        <!--<a href='<?php echo U($module_name.'/view?id='.$vo['id']);?>'>查看</a>&nbsp;&nbsp;-->
                        <a href="<?php echo U($module_name.'/edit?id='.$vo['id']);?>">编辑</a>&nbsp;&nbsp;
                        <a href="<?php echo U('choujiang_award/index?id='.$vo['id']);?>">奖品管理</a>&nbsp;&nbsp;
                        <!--<a href="<?php echo U('choujiang/tongji?id='.$vo['id']);?>">统计信息</a>&nbsp;&nbsp;-->

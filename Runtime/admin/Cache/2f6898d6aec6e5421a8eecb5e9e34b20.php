...
<div class="container">
    <div class="page-header"><h4>菜单编辑</h4></div>
    <div class="row">
        <div class="span12">
            <div class="pull-left">
            ...
            <form class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" placeholder="菜单响应KEY" name="menu_key" value="<?php echo ($info["menu_key"]); ?>" class="input-xlarge">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" placeholder="排序" value="<?php echo ($info["sort"]); ?>" name="sort" class="input-xlarge">

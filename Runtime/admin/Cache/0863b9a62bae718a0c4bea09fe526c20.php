...
<div class="container" style="margin-top: 10px;">
    <div class="row">
        <div class="span4">
            <p>今日新关注用户数：<span style="color:red;font-weight: bold"><?php echo ($subscribe_count); ?></span></p>
            <p>今日取消关注数：<span style="color:red;font-weight: bold"><?php echo ($unsubscribe_count); ?></span></p>
            <p>昨日新关注用户数：<span style="color:red;font-weight: bold"><?php echo ($yesterday_subscribe_count); ?></span></p>
            <p>昨日取消关注数：<span style="color:red;font-weight: bold"><?php echo ($yesterday_unsubscribe_count); ?></span></p>
        </div>

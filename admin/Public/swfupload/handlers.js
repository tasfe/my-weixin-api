...
function uploadSuccess_ll(file, serverData) {
		...
		$('#imgupload_'+img_id).html("<a href='"+ro.small_savepath+ro.filename+"' target='_blank'><img width='80' height='80' src='"+ro.small_savepath+ro.filename+"' /></a><input type='hidden' name='small_"+img_name+"' value='"+ro.small_savepath+"' /><input type='hidden' name='filename_"+img_name+"' value='"+ro.filename+"' /><input type='hidden' name='big_"+img_name+"' value='"+ro.big_savepath+"' /><input type='hidden' name='save_"+img_name+"' value='"+ro.savepath+"' />");
}
